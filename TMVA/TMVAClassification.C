...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TString fname = "./TMVA_ZGJ_WWG.root";
   ...
   dataloader->AddVariable( "MET_mumu","MET_mumu", 'F' );
   dataloader->AddVariable( "dilepton_mass_mumu", "dilepton_mass_mumu", "", 'F' );
   dataloader->AddVariable( "dilepton_g_mass_mumu",                "dilepton_g_mass_mumu", "units", 'F' );
   dataloader->AddVariable( "lepton1_pt_mumu",                "lepton1_pt_mumu", "units", 'F' );

   // You can add so-called "Spectator variables", which are not used in the MVA training,
   // but will appear in the final "TestTree" produced by TMVA. This TestTree will contain the
   // input variables, the response values of all trained MVAs, and the spectator variables

   dataloader->AddSpectator( "spec1 := dilepton_mass_mumu*2",  "Spectator 1", "units", 'F' );
   dataloader->AddSpectator( "spec2 := dilepton_mass_mumu*3",  "Spectator 2", "units", 'F' );
   ...
   TCut mycuts = "channel_mark==3"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "channel_mark==3"; // for example: TCut mycutb = "abs(var1)<0.5";
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=200:nTrain_Background=300:SplitMode=Random:NormMode=NumEvents:!V" );
